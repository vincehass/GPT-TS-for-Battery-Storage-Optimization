...
n2ex_da = pd.read_csv('/Users/nhassen/Documents/ProjectQuant/MyRepos/battery-optimisation-with-drl/data/N2EX_UK_DA_Auction_Hourly_Prices_pytorch_train.csv', header=0)
...
if data_ref == "train":
	...
	scaler = load(open(f'/Users/nhassen/Documents/ProjectQuant/MyRepos/battery-optimisation-with-drl/data/processed_data/da_price_scaler.pkl', 'rb'))
	n2ex_da[['Price_(£)']] = scaler.fit_transform(n2ex_da[['Price_(£)']])
...
# save data
with open(f"/Users/nhassen/Documents/ProjectQuant/MyRepos/battery-optimisation-with-drl/data/processed_data/train_data_336hr_in_24hr_out_unshuffled.pkl", "wb") as trainset:
	dump(train_data, trainset)

with open("/Users/nhassen/Documents/ProjectQuant/MyRepos/battery-optimisation-with-drl/data/processed_data/test_data_336hr_in_24hr_out_unshuffled.pkl", "wb") as testset:
